...
const SolutionSection = () => {
  const features = [
    {
      icon: <BarChart3 className="w-8 h-8 text-vetmind-teal" />,
    ...
    {
      icon: <Smartphone className="w-8 h-8 text-vetmind-teal" />,
    ...
    {
      icon: <History className="w-8 h-8 text-vetmind-teal" />,
    ...
    {
      icon: <Shield className="w-8 h-8 text-vetmind-teal" />,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            {features.map((feature, index) => (
              <Card key={index} className="border-l-4 border-l-vetmind-teal">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-vetmind-navy mb-2">
                        {feature.title}
                      </h3>
