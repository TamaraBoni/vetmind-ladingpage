            ...
            >
              ...
              <div className="mx-auto w-full max-w-[20rem] rounded-xl overflow-hidden border border-black/10 shadow-sm mb-6">
                <iframe
                  ...
                  src="https://www.youtube-nocookie.com/embed/1N3apJvsmSE?si=Wz1-RpgaovHyrkQI&rel=0&modestbranding=1&controls=1"
                  title="Demonstração VetMind"
              ...
              <p className="mt-3 mx-auto max-w-[220px] text-center text-xs leading-snug text-[hsl(var(--vetmind-gray))]">
